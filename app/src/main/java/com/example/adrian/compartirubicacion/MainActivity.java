package com.example.adrian.compartirubicacion;
...
import com.example.adrian.compartirubicacion.services.ServiceObtenerUbicacion;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_coordinates = findViewById(R.id.txtVw_coordinate);
    ...
    private void enable_buttons() {
        btn_start_service.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), ServiceObtenerUbicacion.class);
                startService(intent);
            }
        });
    ...
    public void onClick(View view) {
        if (serviceIsRunning) {
            Toast.makeText(this, R.string.ServiceIsRunning, Toast.LENGTH_SHORT).show();
        }
    }
}
